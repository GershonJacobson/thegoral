        ...
        <div class="modal-content">
          <div class="modal-body">
			...
			<!-- <div class="row">
				<div class="col-md col-50-bn">
					<div class="form-group">
						<label for="startTime">Start Time<small style="color: red">*</small></label> <input autocomplete="off" class="form-control" id="startTime" type="time">
					</div>
				</div>
				<div class="col-md col-50-bn">
					<div class="form-group">
						<label for="endTime">End Time<small style="color: red">*</small></label> <input autocomplete="off" class="form-control" id="endTime" type="time">
					</div>
				</div>
			</div> -->
            <div class="row">
